...
public class VehicleMain {
	public static void main(String args[])
	{
		...
		name = scanner.next();
		Vehicle vehicle1 = new Vehicle(name);	
		int option;
		do {
